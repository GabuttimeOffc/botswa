...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6282395002751@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["6282394002751@s.whatsapp.net"] // GANTI NOMOR LU
			...
			case 'owner':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'report':
                    ...
                    client.sendMessage('6282394002751@s.whatsapp.net', options, text, {quoted: mek})
